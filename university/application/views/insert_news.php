...
<table width="90%" height="551" border="0" cellpadding="5" cellspacing="5" style="margin:auto">
  ...
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="<?php echo base_url();?>/index.php/uni/insert_news">
      
      <table width="58%" height="337" border="0" cellpadding="5" cellspacing="5">
        <tr>
          <td height="70" colspan="2" align="right">:لطفا برای درج خبر فیلد های زیر را پر کنید </td>
          
          </tr>
        <tr>
        <td  width="68%"><?php echo form_error('text'); ?></td>
        ...
        <td  width="68%"><?php echo form_error('text'); ?></td>
          <td align="right"><label for="data"></label>
            <input type="text" name="data" id="data" /></td>
          <td height="70" align="center">:تاریخ ثبت</td>
        </tr>
        <tr>
          <td height="70" colspan="2"><input type="submit" name="button" id="button" value="درج خبر" /></td>
          </tr>
      </table>
    </form></td>
